import{l as g,L,p as P,e as A,C as y,g as b}from"./mapbox-overlay-CjL5nCza.js";import{p as S}from"./picking-CN0D5Hbh.js";const E=new Uint32Array([0,2,1,0,3,2]),I=new Float32Array([0,1,0,0,1,0,1,1]);function T(i,t){if(!t)return M(i);const e=Math.max(Math.abs(i[0][0]-i[3][0]),Math.abs(i[1][0]-i[2][0])),o=Math.max(Math.abs(i[1][1]-i[0][1]),Math.abs(i[2][1]-i[3][1])),a=Math.ceil(e/t)+1,r=Math.ceil(o/t)+1,s=(a-1)*(r-1)*6,n=new Uint32Array(s),l=new Float32Array(a*r*2),d=new Float64Array(a*r*3);let c=0,p=0;for(let u=0;u<a;u++){const f=u/(a-1);for(let m=0;m<r;m++){const h=m/(r-1),v=R(i,f,h);d[c*3+0]=v[0],d[c*3+1]=v[1],d[c*3+2]=v[2]||0,l[c*2+0]=f,l[c*2+1]=1-h,u>0&&m>0&&(n[p++]=c-r,n[p++]=c-r-1,n[p++]=c-1,n[p++]=c-r,n[p++]=c-1,n[p++]=c),c++}}return{vertexCount:s,positions:d,indices:n,texCoords:l}}function M(i){const t=new Float64Array(12);for(let e=0;e<i.length;e++)t[e*3+0]=i[e][0],t[e*3+1]=i[e][1],t[e*3+2]=i[e][2]||0;return{vertexCount:6,positions:t,indices:E,texCoords:I}}function R(i,t,e){return g(g(i[0],i[1],e),g(i[3],i[2],e),t)}const C=`uniform bitmapUniforms {
  vec4 bounds;
