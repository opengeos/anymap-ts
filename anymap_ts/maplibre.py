...
class MapLibreMap(MapWidget):
    ...
    def add_h3_hexagon_layer(
        ...
        data: Any,
        name: Optional[str] = None,
        get_hexagon: Union[str, Any] = "hexagon",
        get_fill_color: Optional[Union[List[int], str]] = None,
        get_line_color: Optional[Union[List[int], str]] = None,
        get_elevation: Union[float, str] = 0,
        filled: bool = True,
        ...
        **kwargs,
        ...
        """Add an H3 hexagon layer for H3 spatial index visualization using deck.gl.

        H3 hexagon layers render hexagons based on H3 spatial indexes,
        enabling efficient hierarchical geospatial indexing visualization.

        Args:
            data: Array of data objects with H3 index strings.
            name: Layer ID. If None, auto-generated.
        ...
        Example:
            ...
            >>> m = MapLibreMap()
            >>> data = [
            ...     {"hexagon": "882a100d63fffff", "value": 10},
            ...     {"hexagon": "882a100d67fffff", "value": 20},
            ... ]
            >>> m.add_h3_hexagon_layer(data, get_fill_color=[255, 0, 0, 128])
        """
        layer_id = name or f"h3hexagon-{len(self._layers)}"
        processed_data = self._process_deck_data(data)
        ...
        self._layers = {
            **self._layers,
            layer_id: {"id": layer_id, "type": "h3hexagon"},
        }
        self._add_to_layer_dict(layer_id, "Deck.gl")
    ...
    def add_great_circle_layer(
        ...
        get_source_position: Union[str, Any] = "source",
        get_target_position: Union[str, Any] = "target",
        get_source_color: Optional[Union[List[int], str]] = None,
        get_target_color: Optional[Union[List[int], str]] = None,
        get_width: Union[float, str] = 1,
        width_min_pixels: float = 1,
        ...
        **kwargs,
        ...
        """Add a great circle layer for geodesic line visualization using deck.gl.

        Great circle layers draw arcs along great circles (geodesic lines),
        ideal for visualizing long-distance routes and connections.
        ...
        Example:
            ...
            ... ]
            >>> m.add_great_circle_layer(routes, get_width=2)
        """
        layer_id = name or f"greatcircle-{len(self._layers)}"
        processed_data = self._process_deck_data(data)
        ...
        self._layers = {
            **self._layers,
            layer_id: {"id": layer_id, "type": "greatcircle"},
        }
        self._add_to_layer_dict(layer_id, "Deck.gl")

    # -------------------------------------------------------------------------
    # Tile3D Layer (deck.gl)
    # -------------------------------------------------------------------------
    ...
    def add_tile3d_layer(
        ...
        **kwargs,
        ...
        """Add a 3D Tiles layer for building/terrain mesh visualization using deck.gl.

        3D Tiles layers render OGC 3D Tiles datasets including buildings,
        terrain meshes, and point clouds from tileset.json endpoints.
        ...
        Example:
            ...
            ... )
        """
        layer_id = name or f"tile3d-{len(self._layers)}"
        ...
        self._layers = {
            **self._layers,
            layer_id: {"id": layer_id, "type": "tile3d"},
        }
        self._add_to_layer_dict(layer_id, "Deck.gl")
    ...
    def add_mvt_layer(
        ...
        **kwargs,
        ...
        """Add a Mapbox Vector Tile (MVT) layer via deck.gl.

        MVT layers render vector tiles using deck.gl's rendering pipeline,
        enabling data-driven styling with accessors.
        ...
        Example:
            ...
            ... )
        """
        layer_id = name or f"mvt-{len(self._layers)}"
    ...
    def add_terrain_layer(
        ...
        **kwargs,
        ...
        """Add a terrain layer for 3D terrain rendering using deck.gl.
        ...
        Example:
            ...
            >>> m = MapLibreMap(pitch=45)
            >>> m.add_terrain_layer(
            ...     "https://s3.amazonaws.com/elevation-tiles/{z}/{x}/{y}.png",
            ...     texture="https://tile.openstreetmap.org/{z}/{x}/{y}.png",
            ... )
        """
        layer_id = name or f"terrain-deck-{len(self._layers)}"
        ...
        self._layers = {
            **self._layers,
            layer_id: {"id": layer_id, "type": "terrain-deck"},
        }
        self._add_to_layer_dict(layer_id, "Deck.gl")
    ...
    def add_s2_layer(
        ...
        data: Any,
        name: Optional[str] = None,
        get_s2_token: Union[str, Any] = "s2Token",
        get_fill_color: Optional[Union[List[int], str]] = None,
        get_line_color: Optional[Union[List[int], str]] = None,
        get_line_width: Union[float, str] = 1,
        get_elevation: Union[float, str] = 0,
        ...
        **kwargs,
        ...
        """Add an S2 layer for S2 geometry cell visualization using deck.gl.
        ...
        Example:
            >>> from anymap_ts import MapLibreMap
            >>> m = MapLibreMap()
            >>> data = [{"s2Token": "1/1", "value": 10}]
            >>> m.add_s2_layer(data)
        """
        layer_id = name or f"s2-{len(self._layers)}"
        processed_data = self._process_deck_data(data)
    ...
    def add_quadkey_layer(
        ...
        data: Any,
        name: Optional[str] = None,
        get_quadkey: Union[str, Any] = "quadkey",
        get_fill_color: Optional[Union[List[int], str]] = None,
        get_line_color: Optional[Union[List[int], str]] = None,
        get_line_width: Union[float, str] = 1,
        get_elevation: Union[float, str] = 0,
        ...
        **kwargs,
        ...
        """Add a Quadkey layer for Bing Maps tile index visualization using deck.gl.
        ...
        Example:
            >>> from anymap_ts import MapLibreMap
            >>> m = MapLibreMap()
            >>> data = [{"quadkey": "0320102", "value": 10}]
            >>> m.add_quadkey_layer(data)
        """
        layer_id = name or f"quadkey-{len(self._layers)}"
        processed_data = self._process_deck_data(data)
        ...
        self._layers = {
            **self._layers,
            layer_id: {"id": layer_id, "type": "quadkey"},
        }
        self._add_to_layer_dict(layer_id, "Deck.gl")
    ...
    def add_geohash_layer(
        ...
        data: Any,
        name: Optional[str] = None,
        get_geohash: Union[str, Any] = "geohash",
        get_fill_color: Optional[Union[List[int], str]] = None,
        get_line_color: Optional[Union[List[int], str]] = None,
        get_line_width: Union[float, str] = 1,
        get_elevation: Union[float, str] = 0,
        ...
        **kwargs,
        ...
        """Add a Geohash layer for geohash cell visualization using deck.gl.

        Args:
            data: Array of data objects with geohash strings.
            name: Layer ID. If None, auto-generated.
        ...
        Example:
            >>> from anymap_ts import MapLibreMap
            >>> m = MapLibreMap()
            >>> data = [{"geohash": "9q8yy", "value": 10}]
            >>> m.add_geohash_layer(data)
        """
        layer_id = name or f"geohash-{len(self._layers)}"
        processed_data = self._process_deck_data(data)
        ...
        self._layers = {
            **self._layers,
            layer_id: {"id": layer_id, "type": "geohash"},
        }
        self._add_to_layer_dict(layer_id, "Deck.gl")
    ...
    def add_simple_mesh_layer(
        ...
        get_position: Union[str, Any] = "coordinates",
        get_color: Optional[Union[List[int], str]] = None,
        get_orientation: Optional[Union[str, Any]] = None,
        get_scale: Optional[Union[str, Any]] = None,
        get_translation: Optional[Union[str, Any]] = None,
        size_scale: float = 1,
        wireframe: bool = False,
        pickable: bool = True,
        opacity: float = 1.0,
        **kwargs,
        ...
        """Add a simple mesh layer for 3D mesh/model placement using deck.gl.
        ...
        Example:
            ...
            >>> m.add_simple_mesh_layer(data, mesh="https://example.com/model.glb")
        """
        layer_id = name or f"simplemesh-{len(self._layers)}"
        processed_data = self._process_deck_data(data)
        ...
        self._layers = {
            **self._layers,
            layer_id: {"id": layer_id, "type": "simplemesh"},
        }
        self._add_to_layer_dict(layer_id, "Deck.gl")
    ...
    def add_scenegraph_layer(
        ...
        **kwargs,
        ...
        """Add a scenegraph layer for glTF/3D scene rendering using deck.gl.
        ...
        Example:
            ...
            >>> m = MapLibreMap(pitch=45)
            >>> data = [{"coordinates": [-122.4, 37.8, 0]}]
            >>> m.add_scenegraph_layer(data, scenegraph="https://example.com/scene.glb")
        """
        layer_id = name or f"scenegraph-{len(self._layers)}"
        processed_data = self._process_deck_data(data)
        ...
        self._layers = {
            **self._layers,
            layer_id: {"id": layer_id, "type": "scenegraph"},
        }
        self._add_to_layer_dict(layer_id, "Deck.gl")
